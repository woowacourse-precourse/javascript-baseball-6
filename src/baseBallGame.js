...
import gameResultPrint from "./gameResultPrint.js";
// 1. Random Number 출력
// 2. 사용자가 입력 할 수 있는 함수 생성 O
// 3. 입력값을 받아서 random Number와 비교 하기
// 4. 비교 후 값에 맞는 문자열 문구 print
// 5. print 후 3스트라이크 일 경우 1 or 2를 입력하는 함수 생성
...
const baseBallGame = async () => {
  ...
  const gameResultString = gameResultPrint(ball,strike);
};
