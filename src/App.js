  ...
  async play() {
    try {
      ...
      while (isGameContinue === '1') {
        ...
        const computerNumbers = [...setNumbers];
        ...
        while (strike !== 3) {
          // 유저가 입력한 숫자, 문자열 형태로 들어온다.
          // const userInputString = await Console.readLineAsync(
          //   '숫자를 입력해주세요'
          // );

          const userInputString = await this.userInput('숫자를 입력해주세요');
        ...
        // const isGameContinue = await Console.readLineAsync(
