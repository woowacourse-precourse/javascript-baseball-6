...
const MESSAGE = {
  ...
  RESTART: `게임을 새로 시작하려면 ${SETTING.RESTART_NUMBER}, 종료하려면 ${SETTING.EXIT_NUMBER}를 입력하세요.`,
}
...
const ERROR_MESSAGE = {
  ...
  NOT_RESTART_NUMBER: `[ERROR] ${SETTING.RESTART_NUMBER} 또는 ${SETTING.EXIT_NUMBER}를 입력하세요.`,
}
