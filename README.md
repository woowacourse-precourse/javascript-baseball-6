...
- [x] MVC 디자인 패턴 폴더 구조 구성

---

- [x] 게임 시작 문구를 출력한다
- [x] 컴퓨터(정답) 숫자를 세팅한다
- [x] 숫자 세개를 인풋으로 입력 받는다
- [x] 입력받은 인풋에 대한 유효성 검사를 진행한다
- [x] 입력받은 인풋의 야구 결과를 출력한다
- [x] 입력받은 인풋의 야구 결과에 따라 다시 입력 받는다
- [x] 입력받은 인풋의 야구 결과에 따라 종료 메세지를 출력한다
- [ ] 종료 혹은 재시작 입력을 받는다
- [ ] 입력받은 인풋에 대한 유효성 검사를 진행한다
- [ ] 재시작시 컴퓨터(정답) 숫자를 새로 세팅하고, 입력 받기를 반복한다
- [ ] 종료시 정상 종료한다
