...
# 구현할 기능 목록
1. 중복되지 않는 랜덤한 3개의 수를 뽑아내서 배열에 저장하는 기능
2. 사용자로부터 중복되지 않는 3개의 수를 입력받고 배열에 저장하는 기능
3. 컴퓨터 배열과 사용자 배열을 비교해 스트라이크와 볼의 개수를 계산하는 기능
4. 계산한 스트라이크와 볼의 개수 또는 “낫싱”을 출력하는 기능
5. 사용자로부터 “1”을 입력받으면 게임 재시작, “2”를 입력받으면 게임을 종료하는 기능
