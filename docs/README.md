...
## ⭕️ 4. 구현할 기능 목록
- 3번 항목을 바탕으로 정리할 구현할 기능 목록이다.

<br>

### 💡 4.1. 게임 시작 직후 루틴<br>
[x] "숫자 야구 게임을 시작합니다." 출력<br>
[x] 1부터 9까지 서로 다른 3개의 수가 담긴 크기 3의 배열 생성

<br>

### 💡 4.2. 게임 동작 루틴 구현
[x] 사용자의 입력을 받는 기능 구현<br>
[x] 사용자의 입력을 검증하고, 입력이 잘못된 경우 에러를 출력하는 기능 구현<br>
[x] 사용자가 입력한 값의 각 자리의 수를 크기가 3인 배열에 각각 삽입하여 반환<br>
[x] 사용자의 입력과 컴퓨터가 생성한 숫자를 비교하여 볼과 스트라이크를 판별하는 기능 구현<br>
[x] 볼과 스트라이크의 개수를 화면에 출력하는 기능 구현

<br>

### 💡 4.3. 게임 종료 루틴 구현
[x] 사용자에게 1, 2 입력을 받아서 프로그램 종료할지, 계속 진행시킬 지 판단하는 기능 구현

<br>

### 💡 4.4. 전체 프로그램 제어
[x] 게임 전체 흐름을 통제하는 main 함수 역할을 하는 play() 메서드 구현
